...
public class GenericArgumentComparatorTest {
    ...
    public void noInheritance() {
        ...
        final List<Class<?>> classListB = asList(GreenReader.class, RedReader.class, GreenReader.class,
                BlueReader.class);
    ...
    public void unrelatedGenericsAreIgnored() throws Exception {
        ...
        final List<Class<?>> classes = classes(SpecialObjectWriter.class, SpecialCircleWriter.class,
                SpecialShapeWriter.class);
