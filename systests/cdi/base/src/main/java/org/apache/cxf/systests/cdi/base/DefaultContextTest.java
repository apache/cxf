...
public abstract class DefaultContextTest extends AbstractBusClientServerTestBase {
    @Test
    ...
    public void testResponseHasBeenReceivedWhenAddingNewBook() {
        Response r = createWebClient("/rest/bookstore/books").post(
                new Form()
                        .param("id", "1234")
    ...
    public void testResponseHasBeenReceivedWhenQueringAllBooks() {
        Response r = createWebClient("/rest/bookstore/books").get();
        assertEquals(Response.Status.OK.getStatusCode(), r.getStatus());
    }
    ...
    public void testAddAndQueryOneBook() {
        ...
        r = createWebClient("/rest/bookstore/books").path(id).get();
        assertEquals(Response.Status.OK.getStatusCode(), r.getStatus());
