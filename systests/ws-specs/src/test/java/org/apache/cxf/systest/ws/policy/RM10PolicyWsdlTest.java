...
public class RM10PolicyWsdlTest extends RMPolicyWsdlTestBase {
    ...
    public static final String PORT = allocatePort(RM10PolicyServer.class);

    private static final Logger LOG = LogUtils.getLogger(RM10PolicyWsdlTest.class);

    public static class RM10PolicyServer extends ServerBase {

        public static void main(String[] args) {
            try {
                RM10PolicyServer s = new RM10PolicyServer();
                s.start();
            } catch (Exception ex) {
                ex.printStackTrace();
                System.exit(-1);
    ...
    public static void startServers() throws Exception {
        ...
        assertTrue("server did not launch correctly", launchServer(RM10PolicyServer.class, true));
    }
