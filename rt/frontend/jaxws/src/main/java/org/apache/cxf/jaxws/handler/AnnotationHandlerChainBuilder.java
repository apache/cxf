...
import org.apache.cxf.jaxws.handler.jakartaee.JakartaeeHandlerChainBuilder;
import org.apache.cxf.jaxws.handler.javaee.JavaeeHandlerChainBuilder;
...
public class AnnotationHandlerChainBuilder extends HandlerChainBuilder {
        ...
        if (hcAnn == null) {
            ...
            try {
                ...
                if (isJavaEENamespace) {
                    chain = new JavaeeHandlerChainBuilder(BUNDLE, handlerFileURL, this::buildHandlerChain)
                        .build(el, portQName, serviceQName, bindingID);
                } else {
                    chain = new JakartaeeHandlerChainBuilder(BUNDLE, handlerFileURL, this::buildHandlerChain)
                        .build(el, portQName, serviceQName, bindingID);
                }
    ...
    private List<Handler> buildHandlerChain(PortComponentHandlerType ht) {
