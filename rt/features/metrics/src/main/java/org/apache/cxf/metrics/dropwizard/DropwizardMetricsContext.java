...
public class DropwizardMetricsContext implements MetricsContext, Closeable {
    ...
    public void close() throws IOException {
        ...
        registry.remove(MetricName.build(baseName, "Attribute=Unchecked Application Faults"));
        registry.remove(MetricName.build(baseName, baseName + "Attribute=Checked Application Faults"));
        registry.remove(MetricName.build(baseName, baseName + "Attribute=Runtime Faults"));
        registry.remove(MetricName.build(baseName, baseName + "Attribute=Logical Runtime Faults"));
        registry.remove(MetricName.build(baseName, baseName + "Attribute=In Flight"));
        registry.remove(MetricName.build(baseName, baseName + "Attribute=Data Read"));
        registry.remove(MetricName.build(baseName, baseName + "Attribute=Data Written"));
    }
