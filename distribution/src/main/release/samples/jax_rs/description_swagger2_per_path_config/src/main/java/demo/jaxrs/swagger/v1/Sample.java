...
@Path("/sample") 
@Api(value = "/v1/sample", description = "Sample JAX-RS service with Swagger documentation")
public class Sample {
    private Map<String, Item> items;

    public Sample() {
        items = Collections.synchronizedMap(new TreeMap<String, Item>(String.CASE_INSENSITIVE_ORDER));
        items.put("Item 1", new Item("Item 1 (v1)", "Value 1"));
        items.put("Item 2", new Item("Item 2 (v1)", "Value 2"));
    }
