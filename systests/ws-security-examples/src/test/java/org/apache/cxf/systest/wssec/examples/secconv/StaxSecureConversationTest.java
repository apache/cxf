 ...
 */
public class StaxSecureConversationTest extends AbstractBusClientServerTestBase {
    ...
    public void testSecureConversation() throws Exception {
        ...
        URL busFile = StaxSecureConversationTest.class.getResource("client.xml");

        Bus bus = bf.createBus(busFile.toString());
        SpringBusFactory.setDefaultBus(bus);
        SpringBusFactory.setThreadDefaultBus(bus);

        URL wsdl = StaxSecureConversationTest.class.getResource("DoubleItSecConv.wsdl");
