...
package org.apache.cxf.jaxws.handler.internal;
...
/**
 * Internal implementation of the handler chain processing. 
 */
@SuppressWarnings("rawtypes")
public abstract class BaseHandlerChainBuilder {
    protected static final String HANDLER_CHAINS_E = "handler-chains";
    protected static final String HANDLER_CHAIN_E = "handler-chain";

    private static JAXBContext context;

    public interface HandlerChainBuilderDelegate {
        List<Handler> buildHandlerChain(PortComponentHandlerType ht);
    }

    private final ResourceBundle bundle;
    private final URL handlerFileURL;
    private final HandlerChainBuilderDelegate delegate;

    protected BaseHandlerChainBuilder(ResourceBundle bundle, URL handlerFileURL, HandlerChainBuilderDelegate delegate) {
        this.bundle = bundle;
