...
public class CodeGenOptionTest extends AbstractCodeGenTest {
    ...
    /**
     * Tests that, when 'supress-generated-date' option is set, @Generated annotations as well as javadocs
     * won't contain the current date in all the generated java classes.
     */
    @Test
    public void testSupressGeneratedDatePresentOption() throws Exception {
        env.put(ToolConstants.CFG_WSDLURL, getLocation("/wsdl2java_wsdl/hello_world.wsdl"));
        env.put(ToolConstants.CFG_MARK_GENERATED, "true");
        env.put(ToolConstants.CFG_SUPRESS_GENERATED_DATE, "true");
        env.put(ToolConstants.CFG_COMPILE, null);
        env.put(ToolConstants.CFG_CLASSDIR, null);
        processor.setContext(env);
        processor.execute();
    ...
    /**
     * Tests that, when 'supress-generated-date' option is not present, @Generated annotations as well as javadocs
     * will contain the current date in all the generated java classes.
     */
    @Test
    public void testSupressGeneratedDateNotPresentOption() throws Exception {
        env.put(ToolConstants.CFG_WSDLURL, getLocation("/wsdl2java_wsdl/hello_world.wsdl"));
        env.put(ToolConstants.CFG_MARK_GENERATED, "true");
        env.put(ToolConstants.CFG_COMPILE, null);
        env.put(ToolConstants.CFG_CLASSDIR, null);
