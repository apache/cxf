...
public class MicrometerTracingTest extends AbstractBraveTracingTest {
    ...
    public static class MicrometerServer extends AbstractTestServerBase {
        ...
        protected void run() {
            ...
            final ObservationRegistry observationRegistry = createObservationRegistry(brave);
    ...
    protected Object getClientProvider(Tracing tracing) {
        return new ObservationClientProvider(createObservationRegistry(tracing),
    ...
    protected Feature getClientFeature(Tracing tracing) {
        return  new ObservationClientFeature(createObservationRegistry(tracing),
    ...
    private static ObservationRegistry createObservationRegistry(final Tracing brave) {
