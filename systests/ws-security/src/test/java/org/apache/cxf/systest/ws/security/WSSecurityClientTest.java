...
public class WSSecurityClientTest extends AbstractBusClientServerTestBase {
    ...
    public void testUsernameToken() throws Exception {
        final jakarta..Service svc
            = jakarta..Service.create(WSDL_LOC, GREETER_SERVICE_QNAME);
    ...
    public void testTimestampSignEncrypt() throws Exception {
        ...
        final jakarta..Service svc = jakarta..Service.create(
            WSDL_LOC,
