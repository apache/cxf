...
/**
 * Large-payload MTOM streaming implementation used by testStreamingMTOMTimingReproducer.
 *
 * The 64 × 1 KB = 64 KB total payload exceeds Jetty's default 32 KB output buffer.
 * Jetty auto-flushes to the client when its buffer fills, so the CXF client receives
 * the complete SOAP body and obtains a lazy DataHandler before the server finishes
