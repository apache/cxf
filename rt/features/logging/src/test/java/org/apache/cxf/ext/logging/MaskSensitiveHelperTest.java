...
public class MaskSensitiveHelperTest {
    ...
    private static final String SENSITIVE_LOGGING_CONTENT_XML_EMPTY_TAG_REPEATED =
       "<user1><password/></user1><user2><password>VALUE</password></user2>";
    private static final String MASKED_LOGGING_CONTENT_XML_EMPTY_TAG_REPEATED =
    ...
    public static Collection<Object[]> primeNumbers() {
        return Arrays.asList(new Object[][] {
            ...
            {SENSITIVE_LOGGING_CONTENT_XML_EMPTY_TAG_REPEATED, MASKED_LOGGING_CONTENT_XML_EMPTY_TAG_REPEATED, APPLICATION_XML},
