...
public class AccessTokenGrantWriter implements MessageBodyWriter<AccessTokenGrant> {
    ...
    @Override
    public long getSize(AccessTokenGrant t, Class<?> type, Type genericType, Annotation[] annotations,
                        MediaType mediaType) {
        return -1;
    }
