 ...
 */
public class StaxXKMSTest extends AbstractBusClientServerTestBase {
    ...
    public void testSymmetricBinding() throws Exception {
        ...
        URL busFile = StaxXKMSTest.class.getResource("client.xml");

        Bus bus = bf.createBus(busFile.toString());
        SpringBusFactory.setDefaultBus(bus);
        SpringBusFactory.setThreadDefaultBus(bus);
        
        URL wsdl = StaxXKMSTest.class.getResource("DoubleItXKMS.wsdl");
