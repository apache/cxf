...
public abstract class AbstractTypeTestClient3 extends AbstractTypeTestClient2 {
    ...
    public void testAnonEnumList() throws Exception {
        ...
        if (testDocLiteral || testXMLBinding) {
            ...
            if (!perfTestOnly) {
                assertEquals("testAnonEnumList(): Incorrect value for inout param", x, y.value);
                assertEquals("testAnonEnumList(): Incorrect value for out param", yOrig, z.value);
                assertEquals("testAnonEnumList(): Incorrect return value", x, ret);
            }
        } else {
