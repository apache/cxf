 ...
 */
public class JCacheReplayCache implements ReplayCache {
    ...
    public JCacheReplayCache(String key) throws WSSecurityException {
        this(key, 10000);
    }

    public JCacheReplayCache(String key, long heapEntries)
        ...
        try {
            ...
            cache = getOrCreate(cacheManager, key, String.class, EHCacheValue.class);
        } catch (Exception ex) {
