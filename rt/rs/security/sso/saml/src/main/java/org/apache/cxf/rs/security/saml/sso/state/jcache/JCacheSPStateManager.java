...
public class JCacheSPStateManager implements SPStateManager {
    ...
    private static <K, V> Cache<K, V> getOrCreate(CacheManager cacheManager, String name,
        ...
        final MutableConfiguration<K, V> requestCacheConfiguration = new MutableConfiguration<>();
        requestCacheConfiguration.setTypes(kclass, vclass);

        return cacheManager.createCache(name, requestCacheConfiguration);
    }
